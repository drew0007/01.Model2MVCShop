...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${product.prodCnt}</td>
		<input type="hidden" name="prodCnt" value="${product.prodCnt}" />
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input		type="text" name="tranCnt" 	class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="5" 
							value="${empty param.cartCnt?'':param.cartCnt }"/>
		</td>
	</tr> --%>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
