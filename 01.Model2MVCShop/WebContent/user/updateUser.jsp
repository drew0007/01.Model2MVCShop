...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		<td width="104" class="ct_write">휴대2전화번호</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<select 	name="phone1" class="ct_input_g" style="width:50px" 
							onChange="document.detailForm.phone2.focus();">
				<option value="010"  ${empty user.phone?"":user.phone.split("-")[0].equals("010")?"selected":"" }>010</option>
				<option value="011"  ${empty user.phone?"":user.phone.split("-")[0].equals("011")?"selected":"" }>011</option>
				<option value="016"  ${empty user.phone?"":user.phone.split("-")[0].equals("016")?"selected":"" }>016</option>
				<option value="018"  ${empty user.phone?"":user.phone.split("-")[0].equals("018")?"selected":"" }>018</option>
				<option value="019"  ${empty user.phone?"":user.phone.split("-")[0].equals("019")?"selected":"" }>019</option>
			</select>
			<input type="text" name="phone2" 
						value= "${! empty user.phone ? user.phone.split("-")[1] : "" }"
						class="ct_input_g" style="width:100px; height:19px"  maxLength="9" >
			- 
			<input type="text" name="phone3" 
						value= "${! empty user.phone ? user.phone.split("-")[2] : "" }"
						class="ct_input_g" style="width:100px; height:19px"  maxLength="9" >
